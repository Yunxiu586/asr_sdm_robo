...
#ifndef _OBJ_PREDICTOR_HPP_
#define _OBJ_PREDICTOR_HPP_
...
public:
  ...
  void setPolynomial(std::vector<Eigen::Matrix<double, 6, 1>>& pls) {
    polys = pls;
  }
...
public:
  ...
  static std::shared_ptr<rclcpp::Node> time_node_;
